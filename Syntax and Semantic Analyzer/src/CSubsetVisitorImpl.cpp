...
void CSubsetVisitorImpl::printError(int line, const string &message) {
...
void CSubsetVisitorImpl::printError(ofstream &out, int line, const string &message) {
...
[[maybe_unused]] static string getArraySize(const string &type) {
...
static vector<string> getArgumentTypes(CSubsetParser::ArgumentsContext *ctx, CSubsetVisitorImpl *visitor) {
    vector<string> result;
    if (ctx == nullptr) return result;
...
[[maybe_unused]] static bool isStandaloneFunctionCall(CSubsetParser::FactorContext *factor) {
...
any CSubsetVisitorImpl::visitStart(CSubsetParser::StartContext *ctx) {
    if (ctx->program() != nullptr) {
        visit(ctx->program());
    }
    int startLine = ctx->getStart() != nullptr ? ctx->getStart()->getLine() : 1;
    logout << "Line " << startLine << ": start : program" << endl << endl;
    symbolTable.print_all_tables(logout);
    int lineCount = ctx->getStop() != nullptr ? ctx->getStop()->getLine() : 0;
    logout << "Total lines: " << lineCount << endl;
    logout << "Total errors: " << errorCount << endl << endl;
    return ctx->getText();
}

any CSubsetVisitorImpl::visitProgram(CSubsetParser::ProgramContext *ctx) {
    string text;
    string rule;
    if (ctx->program() == nullptr) {
...
any CSubsetVisitorImpl::visitUnit(CSubsetParser::UnitContext *ctx) {
    string text;
    string rule;
...
any CSubsetVisitorImpl::visitType_specifier(CSubsetParser::Type_specifierContext *ctx) {
    string rule;
...
any CSubsetVisitorImpl::visitVar_declaration(CSubsetParser::Var_declarationContext *ctx) {
...
any CSubsetVisitorImpl::visitDeclaration_list(CSubsetParser::Declaration_listContext *ctx) {
    string rule;
    string text;
    string name = "";
...
any CSubsetVisitorImpl::visitFunc_declaration(CSubsetParser::Func_declarationContext *ctx) {
...
any CSubsetVisitorImpl::visitFunc_definition(CSubsetParser::Func_definitionContext *ctx) {
...
any CSubsetVisitorImpl::visitParameter_list(CSubsetParser::Parameter_listContext *ctx) {
    string text;
    string rule;
...
any CSubsetVisitorImpl::visitVariable(CSubsetParser::VariableContext *ctx) {
    string name = ctx->ID()->getText();
    int line = ctx->getStart()->getLine();
...
any CSubsetVisitorImpl::visitFactor(CSubsetParser::FactorContext *ctx) {
    int line = ctx->getStart()->getLine();
...
any CSubsetVisitorImpl::visitArgument_list(CSubsetParser::Argument_listContext *ctx) {
    if (ctx->arguments() == nullptr) {
...
any CSubsetVisitorImpl::visitArguments(CSubsetParser::ArgumentsContext *ctx) {
    vector<string> args;
    if (ctx->arguments() != nullptr) {
...
any CSubsetVisitorImpl::visitExpression(CSubsetParser::ExpressionContext *ctx) {
    int line = ctx->getStart()->getLine();
...
any CSubsetVisitorImpl::visitLogic_expression(CSubsetParser::Logic_expressionContext *ctx) {
    int line = ctx->getStart()->getLine();
...
any CSubsetVisitorImpl::visitRel_expression(CSubsetParser::Rel_expressionContext *ctx) {
    int line = ctx->getStart()->getLine();
...
any CSubsetVisitorImpl::visitSimple_expression(CSubsetParser::Simple_expressionContext *ctx) {
    int line = ctx->getStart()->getLine();
...
any CSubsetVisitorImpl::visitTerm(CSubsetParser::TermContext *ctx) {
    int line = ctx->getStart()->getLine();
    if (ctx->MULOP() != nullptr) {
        ...
        if (op == "%") {
            ...
            if (rightText == "0" || rightText == "+0" || rightText == "-0" || rightText == "(0)") {
...
any CSubsetVisitorImpl::visitUnary_expression(CSubsetParser::Unary_expressionContext *ctx) {
    int line = ctx->getStart()->getLine();
...
any CSubsetVisitorImpl::visitStatements(CSubsetParser::StatementsContext *ctx) {
    string previous = "";
...
any CSubsetVisitorImpl::visitStatement(CSubsetParser::StatementContext *ctx) {
    int line = ctx->getStart()->getLine();
    if (ctx->var_declaration() != nullptr) {
...
any CSubsetVisitorImpl::visitExpression_statement(CSubsetParser::Expression_statementContext *ctx) {
    int line = ctx->getStart()->getLine();
    if (ctx->expression() == nullptr) {
...
any CSubsetVisitorImpl::visitCompound_statement(CSubsetParser::Compound_statementContext *ctx) {
